    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                head_cell: 'text-muted-foreground rounded-md w-8 font-normal text-lg',
                ...
                day: cn(buttonVariants({ variant: 'ghost' }), 'h-16 w-16 p-0 font-normal aria-selected:opacity-100'),
